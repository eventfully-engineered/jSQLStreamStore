CREATE OR REPLACE FUNCTION readStreamForwardsWithData(streamId varchar, _streamVersion integer, maxCount integer, OUT lastStreamVersion integer, OUT lastStreamPosition bigint, OUT messages refcursor) AS $$
DECLARE 
