CREATE OR REPLACE FUNCTION readStreamBackwards(streamId varchar, _streamVersion integer, maxCount integer, OUT lastStreamVersion integer, OUT lastStreamPosition bigint, OUT messages refcursor) AS $$
DECLARE 
